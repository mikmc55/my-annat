...
JACKETT_INDEXERS_LIST: list[str] = os.environ.get(
    "JACKETT_INDEXERS",
    "1337x,audiences,eztv,hdsky,isohunt2,keepfriends,kickasstorrents-ws,limetorrents,rutracker-ru,scenehd,springsunday,thepiratebay,totheglorycookie,trellas,yourbittorrent,yts",
).split(",")
